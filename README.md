...
Braille3d is a set of documentation and resources for constructing a braille printer capable of printing a4, blind-legible documents.
...
2. Contact us [TODO: add contact info]

A note on BrailleRap-SP vs Braille3d
------------------------------------

BrailleRap-SP is the original project this documentation is based on, though the designs have been modified somewhat.
